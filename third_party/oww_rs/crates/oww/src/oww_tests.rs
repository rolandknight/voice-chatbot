...
mod tests {
    ...
    fn count_detections(
        ...
        let mut resamplers =
            make_resampler(sample_rate, OWW_MODEL_CHUNK_SIZE as u32, channels).unwrap();
    ...
    fn test_negative_detection(
        ...
        assert_eq!(
            count_detections(NEGATIVE_WAV, OpenWakeWordHeyJarvis, sample_rate, channels),
            0
        );
    }
