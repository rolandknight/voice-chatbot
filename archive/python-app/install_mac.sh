...
echo "  4) Run librespot on the machine with the speaker (it plays natively;"
echo "     the bot only sends control commands). On this Mac:"
echo "       brew install librespot && librespot --name Babel --bitrate 320"
echo "     Then open Spotify on your phone and pick 'Babel' from the Connect menu."
echo "     (On the Raspberry Pi client, see devices/rpi5/README.md instead.)"
echo "     Check visibility: python scripts/spotify.py --list-devices"
echo ""
